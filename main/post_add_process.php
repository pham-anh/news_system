...
//ADD DATA INTO DATABASE
    if (isset($subj) AND isset($categories) AND isset($content)) {
        ...
        $query = "insert into post(subject, category, author, short_content, content, img, topic, ref) values ('$subj', '$categories', '" . $_SESSION['user_id'] . "', '$short_content', '$content', '$file_name', '$post_topics', '$ref'" . ");";
        /* if(isset($new_topic)){
